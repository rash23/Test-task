			...
			<div className="relative bg-black text-white rounded-[10px] p-10 w-full md:w-5/12">
				...
				<div className="flex gap-6 justify-center md:justify-start">
					<div className="cursor-pointer">
						<img src="/assets/images/Contact/social/twitter.svg" alt="" />
					</div>
					<div className="cursor-pointer">
						<img src="/assets/images/Contact/social/instagram.svg" alt="" />
					</div>
					<div className="cursor-pointer">
						<img src="/assets/images/Contact/social/discord.svg" alt="" />
					</div>
				</div>
				<svg
